...
class OpenAIPipeline:
    def __init__(
        self, model_name: str, api_key: str | None = None, temperature: float = 0.1, max_new_tokens: int = 1000
    ):
        """
    ...
    def __call__(
        self, prompt: str, max_new_tokens: int = 1000, return_full_text: bool = False, plot_data: str | None = None
    ):
        """
