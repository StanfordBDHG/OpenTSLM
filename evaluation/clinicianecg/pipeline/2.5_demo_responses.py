...
def add_sample_responses(workbook_path: Path, fill_all_samples: bool = True):
    ...
    response_options = {
        "pattern_recognition": ["Yes", "Some but not all", "None identified"],
        "clinical_reasoning": ["Yes", "Some incorrect logic", "Completely incorrect logic"],
        "context_integration": ["Yes", "Used some key background", "No did not use any relevant background"],
    }
