#!/usr/bin/env python3
"""
Script to evaluate PAMAP2CoTQADataset with a trained EmbedHealthFlamingo model.
...
Requirements:
    - A trained EmbedHealthFlamingo model saved as a .pt file
...
def run_inference_and_collect_data(model: EmbedHealthFlamingo, dataset: PAMAP2CoTQADataset, num_samples: int = 10, max_new_tokens: int = 300, random_seed: int = 42) -> List[Dict[str, Any]]:
