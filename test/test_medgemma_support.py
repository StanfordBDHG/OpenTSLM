#!/usr/bin/env python3
"""
Test script to verify MedGemma support in EmbedHealthFlamingo.
"""
...
def test_medgemma_support():
    """Test that MedGemma can be loaded with EmbedHealthFlamingo."""
    ...
    print("🧪 Testing MedGemma support in EmbedHealthFlamingo")
    print("=" * 60)
