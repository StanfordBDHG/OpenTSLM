...
try:
    ...
    raise ImportError("wfdb library is required for ECG data loading. Please install it with: pip install wfdb") from e
        ...
        for i, ecg_path in enumerate(ecg_paths):
            ...
            for lead_idx in range(n_leads):
                ...
                try:
                    ...
                    raise RuntimeError(
                        f"Failed to create TextTimeSeriesPrompt for lead {lead_name} in file {base_path}: {e!s}"
                    ) from e
