...
MODEL_PREDICTIONS_FILE = (
    "/Users/planger/Development/EmbedHealth/evaluation/embedhealth/ecg_qa_cot/llama3b_flamingo_predictions.jsonl"
)
...
def load_ecg_data(ecg_id: int) -> tuple[np.ndarray, str]:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to load ECG {ecg_id}: {e}") from e
